...
CREATE INDEX IX_DetallesCitaServicios_IDServicio ON DetallesCitaServicio(IDServicio);
CREATE INDEX IX_DetallesCitaServicios_IDCita ON DetallesCitaServicio(IDCita);
